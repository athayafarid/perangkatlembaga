...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="{{ asset('assets/assets-admin/images/favicon.svg') }}" type="image/x-icon"> <!-- [Google Font] Family -->
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="{{ route('warga.index') }}" class="pc-link">
            ...
            <span class="pc-mtext">Datay Warga</span>
          </a>
        </li>
        <li class="pc-item">
      ...
      <div class="card text-center">
        <div class="card-body">
          <img src="{{ asset('assets/assets-admin/images/img-navbar-card.png') }}" alt="images" class="img-fluid mb-2">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
          <div class="list-group list-group-flush w-100">
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/assets-admin/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar">
                </div>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/assets-admin/images/user/avatar-1.jpg') }}" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/assets-admin/images/user/avatar-3.jpg') }}" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/assets-admin/images/user/avatar-4.jpg') }}" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="{{ asset('assets/assets-admin/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar wid-35">
            </div>
...
<!-- [ Header ] end -->
  ...
  <script src="{{ asset('assets/assets-admin/js/plugins/apexcharts.min.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/pages/dashboard-default.js') }}"></script>
  <!-- [Page Specific JS] end -->
  <!-- Required Js -->
  <script src="{{ asset('assets/assets-admin/js/plugins/popper.min.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/plugins/simplebar.min.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/plugins/bootstrap.min.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/fonts/custom-font.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/pcoded.js') }}"></script>
  <script src="{{ asset('assets/assets-admin/js/plugins/feather.min.js') }}"></script>
