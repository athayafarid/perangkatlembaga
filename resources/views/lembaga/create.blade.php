                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <div class="card-body p-4">
                            <form
                                action="{{ isset($lembaga) ? route('lembaga_desa.update', $lembaga) : route('lembaga_desa.store') }}"
                                method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_lembaga"
                                        value="{{ old('nama_lembaga', $lembaga->nama_lembaga ?? '') }}" class="form-control"
                                        placeholder="Masukkan nama lembaga" required>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Keterangan</label>
                                    <textarea name="keterangan" rows="3" class="form-control" placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $lembaga->keterangan ?? '') }}</textarea>
                                </div>
