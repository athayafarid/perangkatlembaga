    ...
    <div class="card border-0 shadow">
        <div class="card-header text-white" style="background:#ffc107;">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('jabatan_lembaga.index') }}" class="btn btn-light btn-sm"><i class="bi bi-arrow-left"></i> Kembali</a>
            </div>
        </div>

        <div class="card-body">
            <form action="{{ isset($jabatan) ? route('jabatan_lembaga.update', $jabatan->id) : route('jabatan_lembaga.store') }}" method="POST">
                @csrf
